        ...
        $window.on("scroll", function () {
            ...
            (o <= 50
                ...
                : ($("header")
                  ...
                  r.attr("src", "/frontend/my-img/new-logo.png")),
                a.attr("src", "/frontend/my-img/new-logo.png"),
                e.attr("src", "/frontend/my-img/new-logo.png"));
        }));
    ...
    const scrollTopPercentage = () => {
        const scrollPercentage = () => {
            ...
            scrollElementWrap.css(
                "background",
                `conic-gradient( #fcaf17 ${scrollValue}%, #1158e7 ${scrollValue}%)`,
            );
    ...
    $(document).ready(function () {
        ...
        (owl.on("changed.owl.carousel", function (e) {
            ...
            $(".odometer").waypoint(
                function (e) {
                    "down" === e &&
                        ((e = $(this.element).attr("data-count")),
                        $(this.element).html(e));
                },
                { offset: "80%" },
            ));
